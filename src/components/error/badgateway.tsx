    ...
    return (
        <div className="flex items-center justify-center h-screen bg-gray-100">
            <div className="text-center">
                <h1 className="text-6xl font-bold text-gray-800">502</h1>
                <p className="text-xl text-gray-600 mt-4">Bad Gateway. The server received an invalid response.</p>
                <p className="text-md text-gray-500 mt-2">Please try again later or contact support if the problem persists.</p>
