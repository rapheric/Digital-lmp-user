    ...
    return (
        <div className="flex items-center justify-center h-screen bg-gray-100">
            <div className="text-center">
                ...
                <p className="text-xl text-gray-600 mt-4">Service Unavailable</p>
                <p className="text-md text-gray-500 mt-2">The service is temporarily unavailable. Please try again later.</p>
