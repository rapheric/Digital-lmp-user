    ...
    return (
        <div className="flex items-center justify-center flex-col h-screen bg-gray-100">
            <div className="text-center">
                <h1 className="text-6xl text-gray-800 font-bold ">502</h1>
                <p className="text-xl text-gray-600 mt-4 ">Request timed out.</p>
                <p className="text-xl text-gray-600 mt-4 ">Retry the request after some time.</p>
